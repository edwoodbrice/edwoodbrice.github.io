...
* <span style="color:black"><div class = "blue">To ensure that the end user was involved every step of the way, I conducted data collection via user testing and surveys. This provided salient insight that benefitted the implementation process.</div></span>
